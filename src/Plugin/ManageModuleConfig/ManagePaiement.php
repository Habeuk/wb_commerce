...
class ManagePaiement extends ManageModuleConfigPluginBase {
  ...
  public function getRoute() {
    ...
    $url = (\Drupal::moduleHandler()->moduleExists('lesroidelareno')) ?
      Url::fromRoute('lesroidelareno.payement_gateways', [
  ...
  public function defaultConfiguration() {
    return [
      ...
      'description' => "Activer et configurer les moyens de paiements",
      'enable' => false,
